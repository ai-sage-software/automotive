...
The API is structured around the domain **parts** and **Part** resource as the primary entity, with several resources scoped under it via various path parameters.
