...
The API is structured around the domain **core** and **Receipt** resource as the primary entity, with several resources scoped under it via various path parameters.
