...
The API is structured around the domain **core** and **GeneralLedgerAccount** resource as the primary entity, with several resources scoped under it via various path parameters.
