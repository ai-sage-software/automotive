...
This contains the OpenAPI specification for the **Automotive Retail Systems API**, which provides an interface for managing automotive retail entities such as **ControlAccountReference**, **GeneralLedgerReference**, **Identifier**, **JournalEntry**, **JournalEntryTransaction**, **Money**, **SubsidiaryLedgerReference**.
