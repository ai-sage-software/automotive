...
Welcome to the **Financial & Payments** domain.

If you are new here, think of this directory as the "Central Bank" of our automotive system. Every time a car is sold, a part is ordered, or an employee is paid, the data eventually flows here to be recorded, tracked, and audited.

This document will guide you through the structure of this repository and explain the core financial concepts we model.
