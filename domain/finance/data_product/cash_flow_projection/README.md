...
This contains the OpenAPI specification for the **Automotive Retail Systems API**, which provides an interface for managing automotive retail entities such as **AccountingPeriod**, **CashFlowLineItem**, **CashFlowProjection**, **CashFlowProjectionCriteria**, **CashFlowScenario**, **Identifier**, **Money**.
