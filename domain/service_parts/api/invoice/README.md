...
The API is structured around the domain **service_parts** and **Invoice** resource as the primary entity, with several resources scoped under it via various path parameters.
