...
This contains the OpenAPI specification for the **Automotive Retail Systems API**, which provides an interface for managing automotive retail entities such as **AddressReference**, **ControlAccountReference**, **CreditReference**, **CustomerOrderReference**, **DiscountReference**, **EffectivePeriod**, **FeeReference**, **FinancialCategoryReference**, **FinancialEvent**, **FinancialSplit**, **FinancialTrackReference**, **Identifier**, **LenderReference**, **Money**, **PartOrder**, **PartOrderItem**, **PartReference**, **PaymentScheduleReference**, **PaymentTermReference**, **Price**, **PricePlanReference**, **RebateReference**, **RewardReference**, **SalesProfileReference**, **ShipmentReference**, **StaffAssignmentReference**, **TaxSplit**, **TextualDetail**, **TimeSlot**, **UnitOfMeasure**.
