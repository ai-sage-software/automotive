...
In the **[`/api`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance)** folder, you will find the "Aggregate Roots" (AR) that define our users.
...
* **[`party`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/party)**: The base record. A Party is either an **Individual** (a human) or an **Organization** (a business).

### 2\. Profiles (Roles)

A "Party" is just a name and an address. A "Profile" is what they *do*.

* **[`customer_profile`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/customer_profile)**: When a Party buys a car, they gain this profile. It holds data like preferences and buying history.
* **[`dealer_profile`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/dealer_profile)**: Represents a franchise location. Contains data like store hours, franchise codes, and certifications.
* **[`organization_profile`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/organization_profile)**: Represents a business entity that *isn't* a dealer (e.g., a Vendor supplying parts or a Bank providing loans).
* **[`staff`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/staff)**: (Linked to HR) Represents a human Party acting as an employee.

### 3\. Location & Discovery

* **[`dealer_locator`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/dealer_locator)**: APIs used by the public website to find the nearest dealership based on zip code or GPS.
* **[`dealer_locator_extended`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/dealer_locator_extended)**: Detailed metadata for the locator, including specific services offered (e.g., "Has EV Charging Station," "Body Shop on site").

-----

## 🔄 Key Functionality & Rules

The **[`/specs`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/specs)** folder details how we manage these identities.
...
1.  **Understanding the Base:** Look at the **[`party`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/party)** schema first. Understand the distinction between an *Individual* and an *Organization*.
2.  **The Customer View:** Look at **[`customer_profile`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/customer_profile)** to see how we extend a basic person with retail data.
3.  **The Network:** Check out **[`dealer_locator`](https://github.com/ai-sage-software/automotive/tree/main/domain/finance/dealer_locator)** to see how we map our physical stores geographically.
