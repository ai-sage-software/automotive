...
This contains the OpenAPI specification for the **Automotive Retail Systems API**, which provides an interface for managing automotive retail entities such as **Address**, **AddressLocale**, **Authorization**, **CommunicationChannel**, **ContactMethod**, **ControlAccount**, **ControlAccountReference**, **DailyHour**, **Department**, **Discount**, **DiscountMetricValue**, **DiscountPolicy**, **EffectivePeriod**, **Garage**, **GarageItem**, **Identifier**, **Link**, **MetricNameValue**, **Money**, **OrgName**, **OrgProfile**, **Party**, **PaymentTermReference**, **PayrollRate**, **Person**, **PersonName**, **Position**, **Price**, **PrivacyEvent**, **PrivacyItem**, **StaffMember**, **TextualDetail**, **TimeSlot**, **VehicleIdentifier**.
...
<span class="api-method-button method-patch">PATCH</span>
    <span class="api-path-summary">
        <span class="api-path">/parties/{partyKey}</span> <br/>
        <span class="api-summary">Partially update a Party entity. updateParty</span>
    </span>
</div>
...
<span class="api-method-button method-patch">PATCH</span>
    <span class="api-path-summary">
        <span class="api-path">/parties/{partyKey}/garages/{garageKey}</span> <br/>
        <span class="api-summary">Partially update a Garage entity. updateGarage</span>
    </span>
</div>
...
<span class="api-method-button method-patch">PATCH</span>
    <span class="api-path-summary">
        <span class="api-path">/parties/{partyKey}/garage-items/{garageItemKey}</span> <br/>
        <span class="api-summary">Partially update a GarageItem entity. updateGarageItem</span>
    </span>
</div>
...
<span class="api-method-button method-patch">PATCH</span>
    <span class="api-path-summary">
        <span class="api-path">/parties/{partyKey}/vehicle-identifiers/{vehicleIdentifierKey}</span> <br/>
        <span class="api-summary">Partially update a VehicleIdentifier entity. updateVehicleIdentifier</span>
    </span>
</div>
