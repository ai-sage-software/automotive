...
The API is structured around the domain **subscriptions** and **GeographicBoundary** resource as the primary entity, with several resources scoped under it via various path parameters.
