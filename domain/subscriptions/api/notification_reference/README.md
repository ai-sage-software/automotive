...
The API is structured around the domain **subscriptions** and **NotificationReference** resource as the primary entity, with several resources scoped under it via various path parameters.
...
> `https://[Your-API-Host]/notification-reference`
