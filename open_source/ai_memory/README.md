...
| **Long-Term (User Profile)** | Persistent (years). | Remembering a customer's preference for text communication over email for future **[Marketing Campaigns](https://www.google.com/search?q=../domains/marketing_loyalty/README.md)**. |
| **Domain Knowledge** | Static, managed (lifetime of the model). | Storing indexed knowledge about every **[Labor Operation](https://www.google.com/search?q=../domains/service_parts/README.md)** to provide accurate service quotes. |
...
* **Knowledge Indexing:** Converts documents and domain data (like all **[Incentive Rules](https://www.google.com/search?q=../domains/incentives_programs/README.md)**) into dense numerical vectors for efficient searching.
...
This module links active sessions to persistent **[Customer Profiles](https://www.google.com/search?q=../domains/party_identity/README.md)**.
...
* **LLM Prompting:** Every call to the **[ai\_llm\_models](https://www.google.com/search?q=../ai_llm_models/README.md)** is first routed through **AI Memory** to retrieve the short-term context and any relevant RAG data.
* **Service Diagnosis:** When a customer initiates a service inquiry, their **[Vehicle Service History](https://www.google.com/search?q=../domains/service_parts/README.md)** is indexed and inserted into the RAG system, allowing the AI to instantly reference past repairs.
* **Sales Nurturing:** AI agents managing **[Sales Leads](https://www.google.com/search?q=../domains/sales_operations/README.md)** use long-term memory to recall past purchase attempts and financial queries, enabling a highly tailored approach.
...
* Implementing multi-modal memory to store and retrieve non-text data, such as images of damage related to a **[Warranty Claim](https://www.google.com/search?q=../domains/warranty/README.md)**.
